...
<body class="main-content">
        ...
        <section class="section sec4 " id="blogs">
            ...
            <div class="about-stats">
                ...
                <div class="progress-bars">
                    ...
                    <div class="progress-bar">
                        <p class="prog-title">Frontend (Pure CSS, Tailwind CSS)</p>
                        <div class="progress-con">
                    ...
                    <div class="progress-bar">
                        <p class="prog-title">CMS (Magento2, Wordpress, MS Sharepoint)</p>
                        <div class="progress-con">
                    ...
                    <div class="progress-bar">
                        <p class="prog-title">Agile Scrum Experience</p>
                        <div class="progress-con">
            ...
            <div class="timeline">   
                ...
                <div class="timeline-item">
                    ...
                    <h5>B.Sc (Hons) in Computing (Information System)<span> <br> University of Greenwich</span></h5>
                </div>
                <div class="timeline-item">
                    <div class="tl-icon">
                        <i class="fas fa-briefcase"></i>
                    ...
                    <h5>Level 5 Diploma in Computing<span> <br> NCC Education</span></h5>
                </div>
                <div class="timeline-item">
                    <div class="tl-icon">
                        <i class="fas fa-briefcase"></i>
                ...
                <div class="contact-content-con">
                    ...
                    <div class="left-contact">
                        ...
                        <div class="contact-info">  
                            ...
                            <div class="contact-item">
                                ...
                                <div class="icon">
                                    ...
                                    <span>Email : <a href="mailto:pyaethuta881@gmail.com">pyaethuta881@gmail.com</a></span>
                        ...
                        <div class="contact-icons">
                            ...
                            <div class="contact-icon">
                                ...
                                <a href="https://www.facebook.com/pyae.thuta.881/" target="_blank">
                                    <i class="fab fa-facebook-f"></i>
                                </a>

                                <a href="https://www.linkedin.com/in/pyaethuta/" target="_blank">
                                    <i class="fab fa-linkedin"></i>
                                </a>

                                <a href="https://github.com/calciferp88" target="_blank">
                                    <i class="fab fa-github"></i>
                                </a>

                                <a href="https://www.instagram.com/pyaethuta_xix/" target="_blank">
                    ...
                    <div class="right-contact">
                        ...
                        <div class="submit-btn">
                            <button onclick="sendEmail()" class="main-btn" style="background-color: transparent;">
    ...
    <script type="text/javascript">
        (function() {
         emailjs.init("lWetrd6PDtLPZO4IQ");
        })();
    </script>
</body>
</html>
